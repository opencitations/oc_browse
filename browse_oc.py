...
browse_config = {
    "browse_base_url": os.getenv("BROWSE_BASE_URL", c["browse_base_url"]),
    "sparql_endpoint": {
...
class SparqlIndex(Sparql):
    def __init__(self):
        Sparql.__init__(self, 
                       browse_config["sparql_endpoint"]["index"],
                       "sparql index", 
                       "/sparql/index")
...
class SparqlMeta(Sparql):
    def __init__(self):
        Sparql.__init__(self, 
                       browse_config["sparql_endpoint"]["meta"],
                       "sparql meta", 
                       "/sparql/meta")
...
if __name__ == "__main__":
    ...
    if args.sync_static or browse_config["sync_enabled"]:
